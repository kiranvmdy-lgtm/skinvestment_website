...
import {
    CreditCard, Settings2, Zap, Package, Stethoscope, Truck, Headphones, Heart,
    UserCheck, Handshake, ShieldCheck, BookOpen, Smartphone, HeartHandshake,
    ArrowRight, Star, Quote,
} from "lucide-react";

const WhyUsPage = () => {
    const usps = [
        { icon: CreditCard, title: "Hassle-free Cashless Facility", description: "Smooth, paperless claims at network hospitals. No upfront payments, no stress." },
        { icon: Settings2, title: "Customized Policy Options", description: "Plans tailored to your specific needs, budget, and family situation." },
        { icon: Zap, title: "Speedy Claim Settlement", description: "Quick processing for peace of mind. We expedite every claim for you." },
        { icon: Package, title: "Wide Range of Products", description: "All insurance types under one roof — life, health, corporate, and more." },
        { icon: Stethoscope, title: "No Health Checkups Required", description: "Simple enrollment process with no medical tests for most plans." },
        { icon: Truck, title: "Doorstep Policy Delivery", description: "Convenient service at your home. No need to visit any branch." },
        { icon: Headphones, title: "Dedicated Claim Support", description: "Expert assistance throughout your claims journey, from filing to settlement." },
        { icon: Heart, title: "Family-Oriented Guidance", description: "Caring advice for your loved ones. We treat your family like our own." },
    ];
                ...
                <section className="pt-28 pb-16 md:pt-36 md:pb-20 bg-gradient-to-br from-primary via-primary to-primary-dark text-primary-foreground relative overflow-hidden">
                    ...
                    <div className="container mx-auto relative z-10 text-center">
                        ...
                        <p className="text-primary-foreground/80 text-lg md:text-xl max-w-2xl mx-auto leading-relaxed">
                            We go above and beyond to ensure your financial security and peace of mind — with transparency, expertise, and genuine commitment.
                        </p>
                    </div>
                </section>
                ...
                <section className="py-10 bg-card border-b border-border">
                    <div className="container mx-auto">
                        <div className="grid grid-cols-3 gap-8 text-center">
                            <div>
                                <div className="font-display text-4xl md:text-5xl font-bold text-primary mb-1">19+</div>
                                <div className="text-muted-foreground text-sm font-medium">Years Experience</div>
                            </div>
                            <div>
                                <div className="font-display text-4xl md:text-5xl font-bold text-primary mb-1">1000+</div>
                                <div className="text-muted-foreground text-sm font-medium">Happy Clients</div>
                            </div>
                            <div>
                                <div className="font-display text-4xl md:text-5xl font-bold text-primary mb-1">98%</div>
                                <div className="text-muted-foreground text-sm font-medium">Claim Success Rate</div>
                            </div>
                        </div>
                    </div>
                </section>
                    ...
                    <div className="container mx-auto">
                        <div className="text-center max-w-3xl mx-auto mb-14">
                            ...
                            <p className="text-muted-foreground text-lg">
                                Backed by 19+ years of experience, here's what sets us apart from the rest.
                            </p>
                        </div>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            {usps.map((usp, index) => (
                                <div key={index} className="group p-8 rounded-2xl bg-card border border-border shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300">
                                    ...
                                    <h3 className="font-display text-lg font-bold text-foreground mb-2">{usp.title}</h3>
                    ...
                    <div className="container mx-auto relative z-10">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            ...
                            <p className="text-primary-foreground/80 text-lg">
                                Discover what drives us — transparency, expertise, and a genuine commitment to your financial well-being.
                            </p>
                        </div>
                    ...
                    <div className="container mx-auto">
                        ...
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {testimonials.map((testimonial, index) => (
                                <div key={index} className="p-8 rounded-2xl bg-muted/30 border border-border shadow-card hover:shadow-card-hover hover:-translate-y-1 transition-all duration-300">
                ...
                <section className="py-16 bg-card border-t border-border">
                    <div className="container mx-auto text-center">
                        ...
                        <p className="text-muted-foreground text-lg mb-8 max-w-xl mx-auto">
                            Join 1000+ families who trust us with their financial security. Let us help you find the perfect plan.
                        </p>
                        <a href="/#contact">
